                                ...
                                content: Center(
                                  child: BackdropFilter(
                                      ...
                                      child: Container(
                                          ...
                                          decoration: BoxDecoration(boxShadow: [BoxShadow(blurRadius: 75,color: Color(0x339B9B9B))],
                                              color: Colors.white,
                                              borderRadius:
                                                  BorderRadius.circular(20)),
                                          child: Center(
                                            child: Container(width: sizeQuery.width*0.1013,height: heightQuery*0.0505,
