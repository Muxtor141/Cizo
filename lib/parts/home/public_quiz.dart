                        ...
                        onTap: () {
                          Navigator.of(context)
                            ...
                            return MultiBlocProvider(providers: [
                              BlocProvider.value(
                                  value: BlocProvider.of<FetchPublicBLoc>(
                                      context)),
                              BlocProvider.value(
                                  value: BlocProvider.of<UpdateListCubit>(
                                      context)),
                              BlocProvider.value(
                                  value:
                                  ...
                                  return MultiBlocProvider(
                                      providers: [
                                        BlocProvider<FetchQuestionBLoc>(
                                            create: (x) => FetchQuestionBLoc()
                                              ..add(UpdateQuestionList())),
                                      ],
                                      child: QuizFound(isPublic:true,
                                          quizTime: state[index].quizTime,
                                          quizCode: state[index].quizCode.toString(),
                                          quizCreator:  state[index].creator,
